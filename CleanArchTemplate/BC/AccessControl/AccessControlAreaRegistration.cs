...
namespace CleanArchTemplate.BC.AccessControl
{
    public class AccessControlAreaRegistration : AreaRegistration
    {
        ...
        public override void RegisterArea(AreaRegistrationContext context)
        {
            context.MapRoute(
                ...
                //new[] { "CleanArchTemplate.BC.AccessControl.Controllers" }
                name: "AccessControl_default",
                url: "AccessControl/{controller}/{action}/{id}",
                defaults: new { controller = "Account", action = "Index", id = UrlParameter.Optional },
                namespaces: new[] { "CleanArchTemplate.BC.AccessControl.Controllers" }
            );
